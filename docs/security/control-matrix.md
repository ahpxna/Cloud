...
| P0 | PR.AA; AC-2, AC-3, AC-7, IA-2, IA-5 | Access control | Invite-only accounts, bounded password verification, token-family replay revocation, device/session revoke API, MFA for admin; evidence: access review | Partial — MFA and real access review pending |
...
| P0 | PR.IR; CP-2, CP-4, CP-9, CP-10 | Resilience | 3-2-1 encrypted backups, immutable/offline copy, quarterly restore drill with RPO/RTO evidence | Planned |
| P0 | DE.CM; AU-2, AU-6, AU-9, AU-12, SI-4 | Logging and monitoring | Structured security events, protected off-host export, alert rules, time sync, retention and review; evidence: alert test | Partial — source events exist; export/alerts pending |
...
| P1 | SSDF PO, PS, PW, RV; SA-11, SA-15, SR-3 | Secure development and supply chain | Threat review, code review, secret scanning, SAST, SBOM, signed release image/provenance, dependency updates | Partial |
| P1 | PR.DS; SI-7 | Integrity | Client/server SHA-256, canonical dedup, durable no-overwrite commit, quarantine, signed manifests, scrub and restore verification | Partial — scheduled scrub/restore pending |
